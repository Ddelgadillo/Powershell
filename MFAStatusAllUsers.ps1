#Script to find users MFA Status

#BEFORE YOU RUN YOU MUST CONNECT TO AZURE ACTIVE DIRECTORY WITHT THE FOLLOWING COMMNAD
#Connect-MsolService
...
#Once the report shows up you can filter out by adding criteria on display
